...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return an {@link Data} object to represent a single earthquake.
     */
    public static List<Data> fetchEarthquakeData(String requestUrl) {
        ...
        List<Data> earthquake = extractFeatureFromJson(jsonResponse);
    ...
    private static List<Data> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                Data earthquake = new Data(mag, city,time,url);
